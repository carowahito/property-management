    ...
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
        <div className='bg-surface shadow rounded-lg p-6'>
          ...
          <p className='text-xs text-neutral-500 mt-1'>{stats.totalUnits} units</p>
        </div>
        <div className='bg-surface shadow rounded-lg p-6'>
          <span className='text-3xl mb-2 block'>👥</span>
          <p className='text-sm text-neutral-600'>Active Tenants</p>
          <p className='text-3xl font-bold text-success-600'>{stats.totalTenants}</p>
          <p className='text-xs text-neutral-500 mt-1'>{stats.occupancyRate}% occupancy</p>
        </div>
        <div className='bg-surface shadow rounded-lg p-6'>
          <span className='text-3xl mb-2 block'>💰</span>
        ...
        <div className='bg-surface shadow rounded-lg p-6'>
          ...
          <p className='text-xs text-neutral-500 mt-1'>From 5 tenants</p>
        </div>
      </div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
        <div className='bg-surface shadow rounded-lg p-6'>
          ...
          <div className='space-y-3'>
            <div className='flex items-start p-3 bg-neutral-50 rounded'>
              <span className='text-2xl mr-3'>💵</span>
              <div>
                <p className='text-sm font-medium'>Payment Received</p>
                <p className='text-xs text-neutral-600'>Unit 4B - $1,500 • 2 hours ago</p>
              </div>
            </div>
            <div className='flex items-start p-3 bg-neutral-50 rounded'>
              <span className='text-2xl mr-3'>🔧</span>
              <div>
                ...
                <p className='text-xs text-neutral-600'>Unit 7A - Plumbing issue • 5 hours ago</p>
              </div>
            </div>
            <div className='flex items-start p-3 bg-neutral-50 rounded'>
              <span className='text-2xl mr-3'>📄</span>
              <div>
                ...
                <p className='text-xs text-neutral-600'>Unit 2C - 12 months • Yesterday</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='bg-surface shadow rounded-lg p-6'>
          ...
          <div className='grid grid-cols-2 gap-3'>
            <button className='p-4 bg-success-50 text-success-700 rounded-lg hover:bg-success-100 transition-colors text-sm font-medium'>
              + Add Property
            </button>
            <button className='p-4 bg-primary-50 text-primary-700 rounded-lg hover:bg-primary-100 transition-colors text-sm font-medium'>
              + Add Tenant
            </button>
