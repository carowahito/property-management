        ...
        <div className="bg-surface shadow rounded-lg p-6">
          ...
          <div className="h-64 flex items-end justify-between space-x-2">
            {[65, 70, 80, 75, 85, 90, 95, 88, 92, 98, 100, 105].map((height, i) => (
              <div key={i} className="flex-1 bg-success-500 rounded-t hover:bg-success-600 transition-colors cursor-pointer" style={{height: `${height}%`}}></div>
            ))}
          </div>
        ...
        <div className="bg-surface shadow rounded-lg p-6">
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              <div className="text-6xl font-bold text-success-600">87.5%</div>
              <p className="text-neutral-600 mt-2">Current Occupancy</p>
            </div>
          </div>
        </div>
      </div>
