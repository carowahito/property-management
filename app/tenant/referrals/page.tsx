    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-3xl font-bold text-blue-600">KES {stats.totalEarned.toLocaleString()}</p>
        </div>
        <div className="bg-white shadow rounded-lg p-6">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Your Unique Referral Link</h2>
        ...
        <p className="mt-3 text-sm text-gray-600">
          Your referral code: <span className="font-mono font-semibold text-gray-900">{referralCode}</span>
        </p>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">2. They Sign a Lease</h3>
            <p className="text-sm text-gray-600">
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">3. You Both Get Rewarded</h3>
            <p className="text-sm text-gray-600">
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="grid grid-cols-4 gap-3">
                  <button className="flex flex-col items-center justify-center p-3 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
                    <span className="text-2xl mb-1">📧</span>
                    <span className="text-xs text-gray-600">Email</span>
                  </button>
                  <button className="flex flex-col items-center justify-center p-3 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors">
                    <span className="text-2xl mb-1">💬</span>
                    <span className="text-xs text-gray-600">WhatsApp</span>
                  </button>
                  <button className="flex flex-col items-center justify-center p-3 border border-gray-200 rounded-lg hover:border-blue-400 hover:bg-blue-50 transition-colors">
                    <span className="text-2xl mb-1">📱</span>
                    <span className="text-xs text-gray-600">SMS</span>
                  </button>
                  <button className="flex flex-col items-center justify-center p-3 border border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-colors">
                    <span className="text-2xl mb-1">🔗</span>
