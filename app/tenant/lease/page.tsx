    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-surface shadow rounded-lg p-6">
        <div className="space-y-4">
          <div>
            <h2 className="text-xl font-semibold text-neutral-900 mb-2">Lease Information</h2>
            <dl className="space-y-2">
              <div className="flex justify-between">
                <dt className="text-neutral-600">Lease ID:</dt>
                <dd className="font-medium">{tenantData.leaseId}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-neutral-600">Move-in Date:</dt>
