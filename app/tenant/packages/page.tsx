        ...
        <div className="space-y-4">
          {packages.filter(p => p.status === 'arrived').length === 0 ? (
            <div className="bg-white shadow rounded-lg p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Packages Waiting</h3>
              ...
              .map((pkg) => (
                <div key={pkg.id} className="bg-white shadow rounded-lg p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <button className="ml-4 px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700">
                      Mark as Picked Up
                    </button>
                  </div>
                </div>
      ...
      {activeTab === 'settings' && (
        <div className="space-y-6">
            ...
            {showDeliveryInstructions ? (
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between py-2 border-b border-gray-100">
                  ...
                  <span className="font-medium text-gray-900">{deliveryInstructions.defaultLocation}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-100">
                  <span className="text-gray-600">Special Instructions</span>
                  <span className="font-medium text-gray-900">{deliveryInstructions.specialInstructions}</span>
                </div>
                <div className="flex justify-between py-2">
                  <span className="text-gray-600">Alternate Recipient</span>
                  <span className="font-medium text-gray-900">{deliveryInstructions.alternateRecipient}</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h3 className="text-sm font-semibold text-blue-900 mb-2">Package Locker System</h3>
