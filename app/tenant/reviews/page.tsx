...
export default function ReviewsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl font-bold text-neutral-900 mb-2">Reviews & Feedback</h1>
      <p className="text-neutral-600 mb-8">Help us improve by sharing your experience</p>
      ...
      <div className="bg-surface shadow rounded-lg p-6 mb-6">
        ...
        <form className="space-y-4">
          ...
          <button type="submit" className="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700">Submit Review</button>
        </form>
      </div>
      ...
      <div className="bg-surface shadow rounded-lg p-6">
        ...
        <div className="space-y-3">
          <div className="p-4 bg-neutral-50 rounded">
            <div className="flex items-center mb-2"><span className="text-yellow-500">⭐⭐⭐⭐⭐</span><span className="ml-2 text-xs text-neutral-500">Nov 1, 2025</span></div>
