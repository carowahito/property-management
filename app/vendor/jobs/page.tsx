    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage and track your assigned jobs</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white shadow rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-orange-600">KES {(activeEarnings / 1000).toFixed(0)}K</p>
        </div>
        <div className="bg-white shadow rounded-lg p-4">
        ...
        <div className="p-6 space-y-4">
          {filteredJobs.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">No {activeTab} jobs</p>
            </div>
          ) : (
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="font-semibold text-gray-900">{job.id} - {job.title}</h3>
                    ...
                    <p className="text-gray-900 mb-3">{job.description}</p>
                    
                    {job.notes && (
                      <p className="text-sm text-gray-600 mb-3 italic">Note: {job.notes}</p>
                    )}
                  ...
                  <div className="ml-4 text-right">
                    <p className="text-2xl font-bold text-gray-900">KES {job.amount.toLocaleString()}</p>
                    <button
                      onClick={() => setSelectedJob(job)}
                      className="mt-3 bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700 text-sm"
                    >
                      View Details
                    </button>
                  </div>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900">{selectedJob.id} - {selectedJob.title}</h2>
                <button
              ...
              <div className="space-y-4">
                ...
                {selectedJob.notes && (
                  <div>
                    ...
                    <p className="text-gray-700 italic">{selectedJob.notes}</p>
                  </div>
                )}
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  {selectedJob.completedDate && (
                    <div>
                      ...
                      <p className="font-medium text-green-600">{new Date(selectedJob.completedDate).toLocaleDateString()}</p>
                    </div>
                  )}
                </div>
