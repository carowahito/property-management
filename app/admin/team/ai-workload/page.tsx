    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-neutral-600">Analyzing team workload...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-neutral-50 p-6 space-y-6">
      ...
      {insights && (
        <>
          {/* Team Health Score */}
          <div className="bg-gradient-to-r from-primary-50 to-indigo-50 border border-primary-200 rounded-lg p-8">
            <div className="text-center">
              <h2 className="text-lg font-semibold text-neutral-900 mb-3">Team Health Score</h2>
              <div className={`text-6xl font-bold mb-2 ${getHealthColor(insights.teamHealth)}`}>
                {insights.teamHealth}%
              </div>
              <p className="text-neutral-700">{insights.summary}</p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    <div className="bg-primary-50 rounded-lg p-4">
                      <div className="text-2xl font-bold text-primary-600">{workloads.length}</div>
                    ...
                    <div className="bg-success-50 rounded-lg p-4">
                      ...
                      <div className="text-sm text-neutral-600">Top Performers</div>
                    </div>
                    <div className="bg-danger-50 rounded-lg p-4">
                      <div className="text-2xl font-bold text-danger-600">
                        {insights.overloadedMembers.length}
                      </div>
                      <div className="text-sm text-neutral-600">Overloaded</div>
                    </div>
                    <div className="bg-yellow-50 rounded-lg p-4">
                      <div className="text-2xl font-bold text-yellow-600">
                        {insights.needsAttention.length}
                      </div>
                      <div className="text-sm text-neutral-600">Needs Attention</div>
                    </div>
                  </div>
                    ...
                    <div className="bg-success-50 border border-green-200 rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {insights.topPerformers.map((member, idx) => (
                          <div
                            key={member.userId}
                            className="bg-surface border border-green-200 rounded-lg p-4"
                          >
                            <div className="flex items-center justify-between mb-2">
                              <h4 className="font-semibold text-neutral-900">{member.userName}</h4>
                              <span className="text-2xl">
                                {idx === 0 ? '🥇' : idx === 1 ? '🥈' : idx === 2 ? '🥉' : '⭐'}
                              </span>
                            </div>
                            <p className="text-sm text-neutral-600 mb-2">{member.department}</p>
                            <div className="space-y-1 text-sm">
                              ...
                              <div className="flex justify-between">
                                <span className="text-neutral-600">Tasks Done:</span>
              ...
              {activeTab === 'workloads' && (
                <div className="space-y-4">
                  {workloads.map((member) => (
                    <div
                      key={member.userId}
                      className="bg-surface border rounded-lg p-4 hover:shadow-md transition"
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <Link
                          ...
                          className="ml-4 px-3 py-1 text-sm text-primary-600 hover:bg-primary-50 rounded-lg transition"
                        >
                          View Details →
                        </Link>
                      </div>
              ...
              {activeTab === 'insights' && (
                <div className="space-y-6">
                    ...
                    <div className="bg-danger-50 border border-danger-200 rounded-lg p-6">
                      ...
                      <div className="space-y-2">
                        {insights.overloadedMembers.map((member) => (
                          <div key={member.userId} className="bg-surface rounded-lg p-3">
                            <div className="flex items-center justify-between">
                              <div>
                                <p className="font-medium text-neutral-900">{member.userName}</p>
                  ...
                  {insights.needsAttention.length > 0 && (
                    <div className="bg-warning-50 border border-orange-200 rounded-lg p-6">
                        ...
                        {insights.needsAttention.map((member) => (
                          <div key={member.userId} className="bg-surface rounded-lg p-3">
                            <div className="flex items-center justify-between">
                              ...
                              <span className="px-2 py-1 bg-warning-100 text-orange-800 text-xs rounded">
                                Review Required
                              </span>
                            </div>
                          </div>
