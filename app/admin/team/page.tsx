...
export default function TeamManagementPage() {
  ...
  const mockTeamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      permissions: ['tenants.view', 'enquiries.manage', 'communications.send', 'tickets.manage'],
      assignedProperties: 0,
    },
    {
      id: 'TM004',
      ...
      lastActive: '2024-11-18T16:45:00',
      permissions: ['maintenance.view', 'maintenance.update', 'inspections.create', 'work-orders.manage'],
    ...
    },
    {
      ...
      lastActive: '2024-11-19T08:20:00',
      permissions: ['properties.manage', 'maintenance.manage', 'vendors.manage', 'inspections.manage'],
      assignedProperties: 25,
    },
    {
      id: 'TM006',
      name: 'Frank Miller',
      ...
      permissions: ['payments.view', 'payments.manage', 'invoices.manage', 'reports.financial'],
      assignedProperties: 0,
    },
    {
      id: 'TM007',
      ...
      lastActive: '2024-11-19T10:00:00',
      permissions: ['properties.manage', 'tenants.manage', 'landlords.manage', 'reports.view', 'team.view'],
      assignedProperties: 35,
    },
    {
      id: 'TM008',
      name: 'Henry Taylor',
      ...
      lastActive: '2024-11-15T14:30:00',
      permissions: ['leads.view', 'leads.edit', 'properties.view', 'viewings.manage'],
    ...
    },
    {
      ...
      phone: '+254 799 777 888',
      role: 'Caretaker',
      department: 'Operations',
      status: 'Active',
      joinedDate: '2024-05-20',
      lastActive: '2024-11-19T07:50:00',
      permissions: ['maintenance.view', 'maintenance.update', 'inspections.create', 'work-orders.manage'],
    ...
    },
    {
      ...
      lastActive: '2024-10-15T12:00:00',
      permissions: ['tenants.view', 'enquiries.manage', 'communications.send'],
      assignedProperties: 0,
    },
  ]
