  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-neutral-600">Manage your property portfolio</p>
      </div>

      <button className="mb-6 bg-primary-600 hover:bg-primary-700 text-white font-semibold py-2 px-4 rounded">+ Add Property</button>
        ...
        {properties.map((property) => (
          <div key={property.id} className="border rounded-lg p-4 hover:shadow-lg transition">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p><strong>Status:</strong> <span className="px-2 py-1 bg-success-100 text-green-800 rounded">{property.status}</span></p>
            </div>
          </div>
        ))}
      </div>
