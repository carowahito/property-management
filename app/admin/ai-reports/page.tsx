                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {report.data.properties.map((prop: any, idx: number) => (
                              <tr key={idx}>
                                <td className="px-4 py-2 text-sm text-gray-900">{prop.name}</td>
                                <td className="px-4 py-2 text-sm text-gray-600">{prop.units}</td>
        ...
        {!report && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-blue-900 mb-2">About AI Reports</h3>
