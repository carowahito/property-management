...
export default function SubleaseManagementPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-neutral-900">Sublease Management</h1>
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="bg-surface shadow rounded-lg p-6">
            <h2 className="text-lg font-semibold text-neutral-900 mb-4">Your Current Lease</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div>
                <p className="text-sm text-neutral-600">Unit</p>
                <p className="text-lg font-medium text-neutral-900">{currentLease.unitNumber}</p>
              </div>
              <div>
                <p className="text-sm text-neutral-600">Lease Period</p>
              ...
              <div>
                ...
                <p className="text-lg font-medium text-neutral-900">KES {currentLease.monthlyRent.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-sm text-neutral-600">Remaining</p>
                <p className="text-lg font-medium text-neutral-900">{currentLease.remainingMonths} months</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface shadow rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-neutral-200 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-neutral-900">Sublease Requests</h2>
              <button
                onClick={() => setActiveTab('request')}
            ...
            {subleaseRequests.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <p className="text-neutral-600 mb-4">No sublease requests</p>
                <button
                  onClick={() => setActiveTab('request')}
                  className="px-4 py-2 bg-primary-600 text-white rounded-md text-sm font-medium hover:bg-primary-700"
                >
                  ...
                  <div key={request.id} className="p-6">
                    ...
                    {request.subtenantName && (
                      <div className="bg-neutral-50 rounded-lg p-4">
                        <h4 className="text-sm font-semibold text-neutral-900 mb-2">Proposed Subtenant</h4>
          ...
          {/* Sublease Policy */}
          <div className="bg-surface shadow rounded-lg p-6">
            <h2 className="text-lg font-semibold text-neutral-900 mb-4">Sublease Policy</h2>
      ...
      {activeTab === 'request' && (
        <div className="bg-surface shadow rounded-lg p-6">
          <h2 className="text-lg font-semibold text-neutral-900 mb-4">Submit Sublease Request</h2>
          <form onSubmit={handleSubmitRequest} className="space-y-6">
            {/* Sublease Period */}
            <div>
              <h3 className="text-sm font-semibold text-neutral-900 mb-3">Sublease Period</h3>
      ...
      {activeTab === 'find' && (
        <div className="space-y-6">
          <div className="bg-surface shadow rounded-lg p-6">
            <h2 className="text-lg font-semibold text-neutral-900 mb-4">Find Qualified Subtenants</h2>
            ...
            <div className="space-y-4">
              {potentialSubtenants.map((person) => (
                <div key={person.id} className="border border-neutral-200 rounded-lg p-4 hover:border-primary-500 transition-colors">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <div className="flex items-center space-x-2 mb-1">
                          <h3 className="font-medium text-neutral-900">{person.name}</h3>
                          {person.verified && (
          ...
          <div className="bg-surface shadow rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-medium text-neutral-900 mb-1">Submit Sublease Request</h3>
                  <p className="text-sm text-neutral-600">Fill out the sublease request form with your dates and reason</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center mr-3">
                ...
                <div>
                  <h3 className="font-medium text-neutral-900 mb-1">Find or Propose Subtenant</h3>
                  <p className="text-sm text-neutral-600">Browse our platform or propose your own qualified subtenant</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center mr-3">
                ...
                <div>
                  <h3 className="font-medium text-neutral-900 mb-1">Background Check</h3>
                  <p className="text-sm text-neutral-600">Property management screens the proposed subtenant</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center mr-3">
                ...
                <div>
                  <h3 className="font-medium text-neutral-900 mb-1">Sign Agreement & Transfer</h3>
                  <p className="text-sm text-neutral-600">Once approved, sign the sublease agreement and transfer possession</p>
                </div>
              </div>
            </div>
          </div>
