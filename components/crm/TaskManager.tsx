  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h3 className="font-semibold text-gray-900 text-lg">Tasks & Reminders</h3>
          <p className="text-sm text-gray-600">Manage tasks and follow-ups for {stakeholderName}</p>
        </div>
